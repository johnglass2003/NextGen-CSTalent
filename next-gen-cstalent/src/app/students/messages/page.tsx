  ...
  return (
    <ProtectedRoute allowedRoles={['student']}>
      ...
      <div className={styles.messagesPage}>
        ...
        <p className={styles.helpText}>Contact the NextGen CS Talent team for assistance</p>
            ...
            <div className={styles.conversationsList}>
              {conversations.length === 0 ? (
                <div className={styles.emptyState}>
                  <p>No messages yet</p>
                  <p className={styles.emptySubtext}>Start a conversation with our support team</p>
                </div>
              ) : (
...
// New Message Modal Component - Students can only message internal team
